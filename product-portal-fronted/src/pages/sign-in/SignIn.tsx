    ...
    return (
        <div className="wrapper-sign-in">
            ...
            <div className="sign-in">
                ...
                <span className="seller-register-content"><span>Hoặc</span>Bạn muốn trở thành Seller? <Link to='/seller-register' className="seller-register-link">Đăng ký Seller</Link></span>
            </div>
        </div>
    )
}